...
class KPN(nn.Module):
    def __init__(self, color=True, burst_length=1, blind_est=True, kernel_size=[5], sep_conv=False,
        ...
        # Layers 2 to 5 are all mean pooling + 3 layers of convolution
        ...
        # Layers 6~8 must be upsampled first and then convolved.
    ...
    def forward(self, data_with_est, data, white_level=1.0):
        ...
        # Start upsampling and perform skip connection at the same time
